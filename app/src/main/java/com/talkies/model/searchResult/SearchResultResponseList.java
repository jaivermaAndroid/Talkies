...
public class SearchResultResponseList implements Serializable
{
    ...
    private final static long serialVersionUID = -3705612284552858875L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SearchResultResponseList) == false) {
            return false;
        }
        SearchResultResponseList rhs = ((SearchResultResponseList) other);
