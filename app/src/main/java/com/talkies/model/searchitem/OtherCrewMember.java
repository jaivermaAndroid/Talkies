...
public class OtherCrewMember implements Serializable
{
    ...
    private final static long serialVersionUID = -8816524794383103383L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OtherCrewMember) == false) {
            return false;
        }
        OtherCrewMember rhs = ((OtherCrewMember) other);
