...
public class TopBannerList implements Serializable
{
    ...
    private final static long serialVersionUID = 2011654234095339360L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TopBannerList) == false) {
            return false;
        }
        TopBannerList rhs = ((TopBannerList) other);
