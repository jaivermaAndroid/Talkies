...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void signUP(Integer phone) {
        Intent mSignUp = new Intent(SignUpActivity.this, OTPVerificationActivity.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.buttonSignup:
                ...
                break;
            case R.id.tv_login:
                Intent mLogin = new Intent(SignUpActivity.this, LoginActivity.class);
                startActivity(mLogin);
                break;
            case R.id.imageView_info:
                Intent mInfo = new Intent(SignUpActivity.this, LoginSignUpInfoActivity.class);
                startActivity(mInfo);
                break;
        }
    }
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Intent mLogin = new Intent(SignUpActivity.this, OTPVerificationActivity.class);
