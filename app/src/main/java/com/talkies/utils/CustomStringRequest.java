...
public class CustomStringRequest  extends Request<CustomStringRequest.ResponseM> {
    ...
    private Response.Listener<ResponseM> mListener;

    public CustomStringRequest(int method, String url, Response.Listener<ResponseM> responseListener, Response.ErrorListener listener) {
